...
public class SettlementSpecification {
    ...
    public static Specification<SettlementEntity> getSettlements(SettlementFilterRequestDto request) {
        return (root, query, cb) -> {
            ...
            if (request.getSearch() != null && !request.getSearch().isEmpty()) {
                ...
                Predicate byReference = cb.like(cb.lower(root.get("reference")), "%" + request.getSearch().toLowerCase() + "%");
